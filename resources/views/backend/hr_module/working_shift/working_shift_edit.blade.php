                ...
                <div class="branch_edit">
                    <div class="row">
                        ...
                        <div class="col-md-10 mb-3">
                            ...
                            <input type="time" placeholder="Green Time" value="{{$findId->g_limit}}" name="g_limit" id="">
                        </div>
                        @error('g_limit')
                        <strong class="text-danger">{{$message}}</strong>
                        @enderror
                        <div class="col-md-10 mb-3">
                            ...
                            <input type="time" placeholder="Orenge Time" value="{{$findId->o_limit}}" name="o_limit" id="">
                        </div>
                        @error('o_limit')
                        <strong class="text-danger">{{$message}}</strong>
                        @enderror
                        <div class="col-md-10 mb-3">
                            ...
                            <input type="time" placeholder="Red Time" value="{{$findId->r_limit}}" name="r_limit" id="">
                        </div>
                        @error('r_limit')
                        <strong class="text-danger">{{$message}}</strong>
                        @enderror
