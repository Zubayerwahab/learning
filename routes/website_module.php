...
//Notice Section
    ...
    Route::post('/new/notice', [WebsiteModuleFourController::class, 'newAddNotice'])->name('newNotice');
    Route::get('/edit-notice/{id}',[WebsiteModuleFourController::class,'editNotice'])->name('edit-notice');
    Route::post('/update-notice/{id}',[WebsiteModuleFourController::class,'updateNotice'])->name('update-notice');
    Route::get('/delete-notice/{id}',[WebsiteModuleFourController::class,'deleteNotice'])->name('delete-notice');
...
Route::post('/new-career', [WebsiteModuleFourController::class, 'newCareer'])->name('new-career');
Route::get('/manage/career', [WebsiteModuleFourController::class, 'manageCareer'])->name('manage_career');
Route::get('/edit-career',[WebsiteModuleFourController::class,'editCareer'])->name('edit-career');
Route::post('/update-career',[WebsiteModuleFourController::class,'updateCareer'])->name('update-career');
Route::get('/delete-career',[WebsiteModuleFourController::class,'deleteCareer'])->name('delete-career');
